...
lint-py:  ## lint python with ruff
	python -m ruff check fsspec_python
	python -m ruff format --check fsspec_python
...
fix-py:  ## autoformat python code with ruff
	python -m ruff check --fix fsspec_python
	python -m ruff format fsspec_python
...
test:  ## run python tests
	python -m pytest -v fsspec_python/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v fsspec_python/tests --cov=fsspec_python --cov-report term-missing --cov-report xml
